    ...
    <section id="addCustomer" class="bg-light mt-1 p-1">
            ...
            <div class="container-lg">
                ...
                <div class="text-center">
                    <h2>EDIT PROFILE</h2>
                    <p class="lead">Want to edit your details? Fill out this form...</p>
                </div>
                <div class="row justify-content-center my-5">
                    <div class="col-lg-6">
                           ...
                           <label for="firstname" class="form-label">Current Username:</label>
                            <div class="mb-4 input-group">
                                <span class="input-group-text">
                                    <i class="bi bi-person-fill text-secondary"></i>
                                </span>
                                <input type="text" name="currentusername" id="firstname" class="form-control"
                            ...
                            <label for="lastname" class="form-label">Enter new username:</label>
                            <div class="mb-4 input-group">
                                <span class="input-group-text">
                                    <i class="bi bi-person-fill text-secondary"></i>
                                </span>
                                <input type="text" name="username" class="form-control" placeholder="e.g. John" />
                                <!-- tooltip -->
                                <span class="input-group-text">
                                    <span class="tt" data-bs-placement="bottom"
                            ...
                            <label for="lastname" class="form-label">Enter new password:</label>
                            <div class="mb-4 input-group">
                                <span class="input-group-text">
