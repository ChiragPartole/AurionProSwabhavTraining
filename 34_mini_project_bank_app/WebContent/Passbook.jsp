...
<nav class="navbar navbar-expand-md navbar-light pt-2 pb-1">
    ...
    <section id="admin" class="bg-light mt-1 p-1">
        <div class="container-lg">
            <div class="text-center">
                <h2>Passbook</h2>
                <p class="lead text-muted">Here you can view all of your transactions.</p>
            </div>
    ...
    <table class="table table-bordered table-light table-responsive">
                ...
                <tbody>
                <c:forEach var="passbook" items="${passbookList}">
                    <tr class="bg-light">
                        
                        <td>${passbook.getSenderAccNO()}</td>
                        <td>${passbook.getReceiverAccNo()}</td>
                        <td>${passbook.getTypeOfTransaction()}</td>
