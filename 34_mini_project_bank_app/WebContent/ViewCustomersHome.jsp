    ...
    <section id="admin" class="bg-light mt-1 p-1">
        <div class="container-lg ">
            <div class="text-center">
                ...
                <p class="lead text-muted">Here you can view all of your customers.</p>

<form action="ViewCustomerController" method="get">
<button type="submit" class="btn btn-outline-primary btn-lg mt-3">VIEW CUSTOMERS</button>
</form>
<form action="ViewAccountsController" method="get">
<button type="submit" class="btn btn-outline-primary btn-lg mt-3">VIEW CUSTOMERS WITH ACCOUNTS</button>
</form>
